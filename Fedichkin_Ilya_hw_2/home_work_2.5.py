...
# В задании под литерой D явно не указан тип и способ выводы цен, должен ли это пыть список или строка через запятую или с рублями и копейками. Сделал несколько вариантов.
# Вариант 1.
